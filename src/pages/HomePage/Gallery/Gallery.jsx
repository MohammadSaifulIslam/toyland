    ...
    return (
        <section className="my-container mt-20">
            ...
            <div className="grid grid-cols-3 gap-5">
                ...
                <div className="col grid gap-5">
                    <div>
                        <img src="https://img.freepik.com/free-photo/child-having-fun-during-playtime_23-2149382746.jpg?size=626&ext=jpg&ga=GA1.2.562300066.1684249269&semt=ais" alt="" className="h-full w-full object-cover"/>
                    </div>
                    <div>
